...
<body>
        ...
        <div class="collapse navbar-collapse" id="navbarNavDropdown">
          <ul class="navbar-nav">
            ...
            <li class="nav-item dropdown active">
              <a class="nav-link dropdown-toggle" href="statistics.php" id="navbarDropdownMenuLink" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                Stats
              </a>
    ...
    <div class="container">
		  <img src="images/phish.jpg" alt="phish" class="img-fluid">
	  </div>
	  <footer class="footer-distributed">
			...
			<div class="footer-left">
				...
				<p class="footer-links">
					...
					|
					<a href="loggedinthepage.php">campaign</a>
					|
